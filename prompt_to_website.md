...
*   实现完整的深色/浅色模式切换功能，默认跟随系统设置，并允许用户手动切换，注意背景颜色和字体颜色不要冲突导致看不清楚。
*   代码结构清晰、语义化，包含适当的注释。
...
*   **延伸阅读:** 分析文件后，提供一份"进一步阅读"的简短清单，推荐 6 本最佳相关书籍或论文，并提供简要说明或链接。
*   **延伸视频:** 分析文件后，提供一份"进一步观看"的简短清单，推荐 6 个最佳相关 Youtube 视频，并提供简要说明或链接。
*   **延伸讨论:** 分析文件后，提供一份"进一步讨论"的简短清单，推荐 6 个最佳相关 Twitter 讨论，并提供简要说明或链接。
